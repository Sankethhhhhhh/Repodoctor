import type { AnalyzeRequest, ReportListResponse, ReportResponse, CompareRequest, CompareResponse } from './types'
...
export async function compareReports(data: CompareRequest): Promise<CompareResponse> {
...
export function exportUrl(reportId: string, format: 'md' | 'html' | 'csv' | 'pdf' | 'sarif'): string {
